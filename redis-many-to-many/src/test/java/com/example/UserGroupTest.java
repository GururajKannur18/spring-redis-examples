...
public class UserGroupTest extends RepositoryTestSupport{
    ...
    public void setUp() throws JsonProcessingException {
		User raj = User.builder().name("Raj Kumar").createdDate(LocalDate.now()).build();
		User parag = User.builder().name("Parag Rane").createdDate(LocalDate.now()).build();
		User sagar = User.builder().name("Sagar Parate").createdDate(LocalDate.now()).build();
